...
#            Converter_ = Convertor.Convertor(files_list_[0], 0.0, preprocessor=args.preprocessor)
            ...
            et_correlation_gen = display.correlation(dists_gen[3],dists_gen[5])
            rt_correlation_gen = display.correlation(dists_gen[4],dists_gen[5])
            zt_correlation_gen = display.correlation(dists_gen[6],dists_gen[5])
            wandb.log({"et_correlation":et_correlation_gen, "rt_correlation": rt_correlation_gen, "zt_correlation_gen": zt_correlation_gen})
