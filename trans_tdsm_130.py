...
import sdes as sdes
import display_test as display
...
def train_model(files_list_, device='cpu',serialized_model=False):
    ...
    output_files = './training_result/training_epoch_1000_different_shower_different_loss_'+datetime.now().strftime('%Y%m%d_%H%M')+'_output/'
