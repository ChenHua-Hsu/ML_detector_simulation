...
if __name__ == '__main__':
  ...
  parser.add_argument('--config_file', type=str, default = '/eos/user/c/chenhua/copy_tdsm_encoder_sweep16/configs/latex_test.yml',help = 'configuration file for wandb')
  parser.add_argument('--python_cfg', type=str, default = 'latex_problem_fix_random_generate.py', help = 'python file to run the code')
  ...
  sweep_yml['parameters']['inputs']= {'value': os.path.join(CWD, "full_quantile_dataset")}
  sweep_yml['parameters']['preprocessor'] = {'value': os.path.join(CWD, "full_quantile_dataset/dataset_2_padded_transform_incident_later_nentry130To258_preprocessor.pkl")}
