...
import sdes as sdes
import display_doesnot_remove_tail as display 
...
#                trained_model_name = 'training_20240408_1350_output/ckpt_tmp_299.pth'
                trained_model_name = '/eos/user/c/chenhua/copy_tdsm_encoder_sweep16/training_result/training_robust_fulldataset20241215_1648_output/ckpt_tmp_199.pth'
                output_directory = generate(files_list_, load_filename=trained_model_name, device=device)
