...
if __name__ == '__main__':
  ...
  parser.add_argument('--config_file', type=str, default = '/eos/user/c/chenhua/copy_tdsm_encoder_sweep16/configs/diff_loss_on_diff_bucket.yml',help = 'configuration file for wandb')
