...
if __name__ == '__main__':
  ...
  parser.add_argument('--config_file', type=str, default = '/eos/user/c/chenhua/copy_tdsm_encoder_sweep16/configs/quantile_xyz_sweep.yml',help = 'configuration file for wandb')
  parser.add_argument('--python_cfg', type=str, default = 'trans_tdsm_130_generate.py', help = 'python file to run the code')
  parser.add_argument('--n_run', type=int, default = 30, help = 'number of runs')
  ...
  sweep_yml['parameters']['inputs']= {'value': os.path.join(CWD, "full_quantile_xyz")}
  sweep_yml['parameters']['preprocessor'] = {'value': os.path.join(CWD, "full_quantile_xyz/dataset_2_padded_transform_incident_later_nentry130To258_preprocessor.pkl")}
