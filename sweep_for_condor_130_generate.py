...
if __name__ == '__main__':
  ...
  parser.add_argument('--config_file', type=str, default = '/eos/user/c/chenhua/copy_tdsm_encoder_sweep16/configs/quantile.yml',help = 'configuration file for wandb')
  ...
  sweep_yml['parameters']['inputs']= {'value': os.path.join(CWD, "test_dataset")}
  sweep_yml['parameters']['preprocessor'] = {'value': os.path.join(CWD, "test_dataset/dataset_2_padded_transform_incident_later_nentry130To258_preprocessor.pkl")}
